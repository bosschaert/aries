...
public class StartAction extends AbstractAction {
	...
	private void startResource(Resource resource, Coordination coordination) throws BundleException, IOException {
		...
		if (SubsystemConstants.SUBSYSTEM_TYPE_APPLICATION.equals(type)
		    ...
		    ContentHandler customHandler = CustomResources.findCustomContentHandler(instigator, type);
		    if (customHandler != null) {
	            customHandler.start(ResourceHelper.getSymbolicNameAttribute(resource), type, instigator, coordination);
		    } else {
