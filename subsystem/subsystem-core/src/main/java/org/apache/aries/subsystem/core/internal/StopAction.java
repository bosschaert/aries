...
public class StopAction extends AbstractAction {
	...
	private void stopResource(Resource resource) throws BundleException, IOException {
		...
		if (SubsystemConstants.SUBSYSTEM_TYPE_APPLICATION.equals(type)
		    ...
		    ContentHandler customHandler = CustomResources.findCustomContentHandler(requestor, type);
		    if (customHandler != null) {
		        customHandler.stop(ResourceHelper.getSymbolicNameAttribute(resource), type, requestor);
		    } else {
